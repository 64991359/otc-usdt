...
class OrderSell extends Model
{
     ...
     * @return array
     */
    public function getSellList($limit=1, $where = [])
    {
        try {
     ...
     * @return array
     */
    public function editSellOrder($param)
    {
        try {
     ...
     * @return array
     */
    public function delOrderSell($id)
    {
        try {
     ...
     * @return array
     */
    public function getOrderSellById($id)
    {
        try {
...
{ 
	$status =[0=>'<font color="#009688">等待订单</font>',1=>'<font color="blue">匹配成功</font>',2=>'<font color="green">订单完成</font>',3=>'<font color="red">买家撤单</font>',4=>'订单过期'];
	return $status[$value];
}
